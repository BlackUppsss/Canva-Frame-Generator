...
export const App = () => {
    ...
    return (<div className={styles.scrollContainer}>
      <Rows spacing="2u">
        ...
        <Button stretch loading={loading} disabled={loading || !isRequiredFeatureSupported} variant="secondary" onClick={setBackgroundToSolidColor}>
          Set background to a solid color
        </Button>
        <Button stretch variant="secondary" loading={loading} disabled={loading || !isRequiredFeatureSupported} onClick={setBackgroundImage}>
          Set background to an image
        </Button>
        <Button stretch variant="secondary" loading={loading} disabled={loading || !isRequiredFeatureSupported} onClick={setBackgroundVideo}>
