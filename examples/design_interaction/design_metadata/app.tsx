...
export const App = () => {
    const [designMetadata, setDesignMetadata] = useState<DesignMetadata | undefined>();
    ...
    return (<div className={styles.scrollContainer}>
      <Rows spacing="3u">
        ...
        <FormField label="Design metadata" value={JSON.stringify(designMetadata, null, 2)} control={(props) => (<MultilineInput {...props} maxRows={12} autoGrow readOnly/>)}/>
      </Rows>
    </div>);
};
