import { Avatar, Button, Columns, Column, LoadingIndicator, Rows, Title, Text, Box, } from "@canva/app-ui-kit";
...
export function App() {
    ...
    const oauth = useMemo(() => auth.initOauth({ type: "multi_account", provider: PROVIDER }), []);
    ...
    return (<div className={styles.scrollContainer}>
      <Box justifyContent="center" width="full" height="full" alignItems="center" display="flex">
        <Rows spacing="2u">
          ...
          <OauthAccountSwitcher oauth={oauth} scope={scope} authorizationQueryParams={{
            access_type: "offline",
            prompt: "login",
        }} signInLabel="Sign in" triggerLabel="Switch Account" appName="Multi-account demo" onAccountSwitch={handleAccountSwitch}/>

          {selectedAccount ? (<>
              <Box padding="2u" border="standard" borderRadius="standard" background="neutral">
                <Rows spacing="2u">
                  <Title size="small">Selected Account</Title>
                  <Columns spacing="2u" alignY="center">
                    <Column width="content">
                      <Avatar name={selectedAccount.displayName} photo={selectedAccount.avatarUrl}/>
                    </Column>
                    <Column>
                      <Rows spacing="1u">
                    ...
                    <Column width="content">
                      <Button variant="primary" onClick={() => fetchProfile(selectedAccount)} disabled={loading}>
              ...
              {(profile || profileError || loading) && (<Box padding="3u" border="standard" borderRadius="standard" background="neutral">
                  <Rows spacing="2u">
                    ...
                    {profileError && (<Box padding="2u" borderRadius="standard" border="standard">
                        <Text>Error: {profileError}</Text>
                      </Box>)}

                    {profile && (<Box padding="2u" background="neutral" borderRadius="standard">
                        <Text size="small">
