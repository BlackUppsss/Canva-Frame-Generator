...
export const InteractionPage = (props: InteractionPageProps) => {
    return (<Rows spacing="1.5u">
      ...
      <Button disabled={!props.isInteractionSupported} variant="secondary" onClick={() => addElementAtPoint({ type: "shape", ...shape })}>
        Add a shape at a point
      </Button>
      <Button disabled={!props.isInteractionSupported} variant="secondary" onClick={() => addElementAtPoint({
            type: "group",
            children: [
                {
                    type: "shape",
      ...
      <Button disabled={!props.isInteractionSupported} variant="secondary" onClick={() => addPage()}>
        Add a new page
      </Button>
    </Rows>);
};
...
const UnsupportedAlert = () => (<Alert tone="warn" title="Shapes, Groups and Pages can't be added to Docs.">
