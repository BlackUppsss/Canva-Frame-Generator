import type { DataTable, DataTableImageUpload, DataTableVideoUpload, GetDataTableRequest, } from "@canva/intents/data";
...
export const getRealEstateData = async (request: GetDataTableRequest): Promise<DataTable> => {
...
const transformToDataTable = (projects: RealEstateProject[], selectedStages: string[]): DataTable => {
    const columnConfigs = [
