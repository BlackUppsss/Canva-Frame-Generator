...
export const ObjectPanel = () => {
    ...
    if (overlay.isOpen) {
        ...
        <Rows spacing="3u">
          ...
          <Rows spacing="1.5u">
            <Button variant="secondary" disabled={!isImageReady} onClick={handleInvert} stretch>
              Invert colors
            </Button>
            <Button variant="secondary" disabled={!isImageReady} onClick={handleBlur} stretch>
              Add blur
            </Button>
            <Button variant="secondary" disabled={!isImageReady} onClick={handleReset} stretch>
              Reset changes
            </Button>
          </Rows>
          <Rows spacing="1.5u">
            <Button variant="primary" disabled={!isImageReady} onClick={handleSave} stretch>
              Save and close
            </Button>
            <Button variant="secondary" disabled={!isImageReady} onClick={handleClose} stretch>
    ...
    return (<div className={styles.scrollContainer}>
      <Rows spacing="3u">
        ...
        <Button variant="primary" disabled={!overlay.canOpen} onClick={handleOpen} stretch>
          Edit image
        </Button>
...
const SelectionAlert = () => (<Alert tone="info">
