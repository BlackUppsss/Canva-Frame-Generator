...
export const useConfig = (): Config<ContainerTypes> => {
    ...
    return {
        serviceName: intl.formatMessage({
            ...
            description: "Name of the service where the app will pull digital assets from",
        }),
        search: {
            enabled: true,
            filterFormConfig: {
                        ...
                        options: [
                            {
                                ...
                                label: intl.formatMessage({
                                    ...
                                    description: "One of the filter options for asset update date",
                                }),
                            },
                            {
                                value: ">now-7d",
                        ...
                        options: [
                            {
                                ...
                                label: intl.formatMessage({
                                    ...
                                    description: "One of the filter options for asset design status",
                                }),
                            },
                            {
                                value: "rejected",
        ...
        moreInfoMessage: intl.formatMessage({
            defaultMessage: "At the moment, we only support images and videos. Corrupted and unsupported files will not appear.",
