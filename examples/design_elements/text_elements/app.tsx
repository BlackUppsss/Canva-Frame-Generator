import { Button, ColorSelector, FormField, Rows, Select, Text, TextInput, Title, } from "@canva/app-ui-kit";
import { addElementAtCursor, addElementAtPoint, type FontWeight, type TextAttributes, } from "@canva/design";
...
export const App = () => {
    ...
    return (<div className={styles.scrollContainer}>
      <Rows spacing="2u">
        ...
        <FormField label="Font style" value={fontStyle} control={(props) => (<Select<TextAttributes["fontStyle"]> {...props} stretch onChange={(style) => {
                setState((prevState) => {
                    return {
                        ...prevState,
                        fontStyle: style,
        ...
        <FormField label="Text align" value={textAlign} control={(props) => (<Select<TextAttributes["textAlign"]> {...props} stretch onChange={(textAlign) => {
                setState((prevState) => {
                    return {
                        ...prevState,
                        textAlign,
        ...
        <Button variant="primary" onClick={addText} disabled={disabled || !addElement} tooltipLabel={!addElement
