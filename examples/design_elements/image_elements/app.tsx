import { Box, Button, FormField, Grid, ImageCard, Rows, Text, } from "@canva/app-ui-kit";
...
export const App = () => {
    ...
    return (<div className={styles.scrollContainer}>
      <Rows spacing="2u">
        ...
        <Button variant="primary" disabled={disabled || !addElement} tooltipLabel={!addElement
            ? "This feature is not supported in the current page"
            : undefined} loading={isLoading} onClick={addImage} stretch>
          Add element
        </Button>
      </Rows>
    </div>);
