...
const HEART_PATH = "M 20 10 C 20.97 5 22.911 0 29.702 0 C 36.494 0 41.83 5 39.405 15 C 36.979 25 25.821 30 20 40 C 14.179 30 3.021 25 0.595 15 C -1.8304 5 3.5059 0 10.298 0 C 17.089 0 19.03 5 20 10 Z";
export const App = () => {
    ...
    return (<div className={styles.scrollContainer}>
      <Rows spacing="3u">
        ...
        <Rows spacing="1.5u">
          <Button onClick={addShapeWithImageFill} variant="secondary" disabled={!isRequiredFeatureSupported} stretch>
            Add shape element with image fill
          </Button>
          <Button onClick={addShapeWithVideoFill} variant="secondary" disabled={!isRequiredFeatureSupported} stretch>
