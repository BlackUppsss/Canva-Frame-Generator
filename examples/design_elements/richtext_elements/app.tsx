...
import { addElementAtCursor, addElementAtPoint, createRichtextRange, } from "@canva/design";
...
export const App = () => {
    ...
    return (<div className={styles.scrollContainer}>
      <Rows spacing="2u">
        ...
        <Button variant="primary" onClick={addToDesign} disabled={!addElement} tooltipLabel={!addElement
...
const Regions = ({ regions }: {
    ...
    return (<pre style={{ textWrap: "wrap", fontSize: 14 }}>
