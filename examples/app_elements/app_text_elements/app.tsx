import { Button, ColorSelector, FormField, NumberInput, RadioGroup, Rows, Select, Text, TextInput, Title, } from "@canva/app-ui-kit";
import type { AppElementOptions, FontWeight, TextAttributes, } from "@canva/design";
...
export const App = () => {
    ...
    const { data: { text, color, fontWeight, fontStyle, decoration, textAlign, width, rotation, useCustomWidth, }, } = state;
    ...
    return (<div className={styles.scrollContainer}>
      <Rows spacing="2u">
        ...
        <FormField label="Color" control={() => (<ColorSelector color={color} onChange={(value) => {
                setState((prevState) => {
                    return {
                        ...prevState,
                        data: {
        ...
        <FormField label="Font style" value={fontStyle} control={(props) => (<Select<TextAttributes["fontStyle"]> {...props} options={[
        ...
        <FormField label="Font weight" value={fontWeight} control={(props) => (<Select<FontWeight> {...props} options={[
                { value: "normal", label: "Normal" },
        ...
        <FormField label="Decoration" value={decoration} control={(props) => (<Select<TextAttributes["decoration"]> {...props} options={[
        ...
        <FormField label="Text align" value={textAlign} control={(props) => (<Select<TextAttributes["textAlign"]> {...props} options={[
        ...
        <FormField label="Width" value={useCustomWidth} control={(props) => (<RadioGroup {...props} options={[
                {
        ...
        {useCustomWidth ? (<FormField label="Width" value={width} control={(props) => (<NumberInput {...props} min={1} onChange={(value) => {
                    setState((prevState) => {
                        return {
                            ...prevState,
                            data: {
