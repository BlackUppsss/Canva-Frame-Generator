...
export const App = () => {
    ...
    const onDragStartForExternalImage = (event: React.DragEvent<HTMLElement>) => {
        const dragData: ImageDragConfig = {
            ...
            previewUrl: "https://www.canva.dev/example-assets/image-import/grass-image-thumbnail.jpg",
            previewSize: {
                width: 320,
                height: 212,
            },
    ...
    return (<div className={styles.scrollContainer}>
      <Rows spacing="3u">
        ...
        <Rows spacing="1u">
          ...
          <ImageCard ariaLabel="Add image to design" alt="dog image" thumbnailUrl={dog} onDragStart={onDragStartForLocalImage} onClick={insertLocalImage} disabled={!addElement}/>
        </Rows>
        <Rows spacing="1u">
          ...
          <ImageCard ariaLabel="Add image to design" alt="grass image" thumbnailUrl="https://www.canva.dev/example-assets/image-import/grass-image.jpg" onClick={insertExternalImage} onDragStart={onDragStartForExternalImage} disabled={!addElement}/>
        </Rows>
      </Rows>
    </div>);
};
