    ...
    return (<AudioContextProvider>
      <div className={styles.scrollContainer}>
        <Rows spacing="1u">
          ...
          <AudioCard audioPreviewUrl="https://www.canva.dev/example-assets/audio-import/audio.mp3" durationInSeconds={AUDIO_DURATION_MS / 1000} ariaLabel="Add audio to design" title="MP3 audio track" onDragStart={onDragStart} onClick={insertAudio} disabled={!isSupported(addAudioTrack) || !isSupported(ui.startDragToPoint)}/>
        </Rows>
      </div>
