import { Box, Button, LoadingIndicator, Rows, Text, Title, } from "@canva/app-ui-kit";
...
export const Login = () => {
    ...
    return (<div className={styles.scrollContainer}>
      <Box justifyContent="center" width="full" alignItems="center" display="flex" height="full">
        ...
        {!loading && !error && (<Rows spacing="2u">
            <Header title={intl.formatMessage(loginMessages.signInRequired)} showBack={false}/>
            <Text>
...
const loginMessages = defineMessages({
    authorizationError: {
        ...
        description: "Title displayed when there is an error during OAuth authorization",
    },
    tryAgain: {
    ...
    signInRequired: {
        ...
        description: "Header title for the login page indicating authentication is needed",
    },
    dataConnectorsOAuth: {
        defaultMessage: "Data connectors can use OAuth to authenticate with other platforms.",
        description: "Body text shown when the user is prompted to sign in",
    },
    exampleDemonstration: {
        defaultMessage: "This example demonstrates how to do this with the Canva Connect API.",
        description: "Body text shown when the user is prompted to sign in",
    },
    setupInstructions: {
        defaultMessage: "For set up instructions please see the README.md in the root folder.",
        description: "Body text shown when the user is prompted to sign in",
    },
    signIntoCanva: {
