import type { DataTable, DataTableMetadata, GetDataTableCompleted, GetDataTableError, } from "@canva/intents/data";
export const completeDataTable = (dataTable: DataTable, metadata?: DataTableMetadata): GetDataTableCompleted => {
    return {
        status: "completed",
        dataTable,
        metadata,
