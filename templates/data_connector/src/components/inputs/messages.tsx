...
export const ownershipFilter = defineMessages({
    ...
    description: {
        defaultMessage: "Filter the list of designs based on the user's ownership of the designs",
...
export const datasetFilter = defineMessages({
    ...
    description: {
        defaultMessage: "Filter the list of brand templates based on the dataset definitions",
